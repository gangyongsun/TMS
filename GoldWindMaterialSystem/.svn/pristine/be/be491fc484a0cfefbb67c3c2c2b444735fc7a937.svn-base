...
public class JedisShiroSessionRepository implements ShiroSessionRepository {
	public static final String REDIS_SHIRO_SESSION = "goldwind-shiro-session:";
	/**
	 * 这里有个小BUG，因为Redis使用序列化后，Key反序列化回来发现前面有一段乱码，解决的办法是存储缓存不序列化
	 */
	public static final String REDIS_SHIRO_ALL = "*goldwind-shiro-session:*";
	...
	public void saveSession(Session session) {
		...
		try {
			...
			/**
			 * 之前上面不小心给我加了0，也就是 18000 / 3600 = 5 个小时
