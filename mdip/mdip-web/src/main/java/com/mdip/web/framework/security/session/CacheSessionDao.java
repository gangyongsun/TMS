package com.mdip.web.framework.security.session;
...
import com.mdip.web.framework.security.web.Servlets;
 ...
 */
@Slf4j
public class CacheSessionDao extends EnterpriseCacheSessionDAO implements ISessionDao {
	...
	protected void doUpdate(Session session) {
		...
		if (request != null) {
			...
			// 如果是视图文件，则不更新SESSION
			if (StrUtil.startsWith(uri, Config.prefix) && StrUtil.endsWith(uri, Config.suffix)) {
				return;
			}
			// 手动控制不更新SESSION
